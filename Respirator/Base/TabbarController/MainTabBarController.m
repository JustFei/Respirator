...
-(void)setUpAllChildViewController{
    ...
    //PM2.5页面
    PM2_5ViewController *PM2_5VC = [PM2_5ViewController new];
    [self setupChildViewController:PM2_5VC title:@"PM2.5" imageName:@"pm_ic_normal" seleceImageName:@"pm_ic_pressed"];
    
    //计步页面
    StepViewController *stepVC = [[StepViewController alloc]init];
    [self setupChildViewController:stepVC title:@"计步" imageName:@"step_ic_normal" seleceImageName:@"step_ic_pressed"];
    
    //设置页面
    SettingViewController *settingVC = [[SettingViewController alloc]init];
    [self setupChildViewController:settingVC title:@"设置" imageName:@"set_ic_normal" seleceImageName:@"set_ic_pressed"];
